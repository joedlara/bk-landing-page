...
const Features = () => {
  const iconMap = {
    'map-pin': (
      <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"><circle cx="12" cy="10" r="3"></circle></path>
    ),
    'trending-up': (
      <>
    ...
    <section className="features-section scroll-fade-in" id="services">
      <div className="features-grid">
        ...
        {featuresData.map((feature, index) => {
          ...
          return (
            <div key={feature.id} className={`feature-card glass ${animationClass}`}>
